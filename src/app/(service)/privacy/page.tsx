	...
	return (
		<section className="mx-auto p-4 max-w-200 border-gray-200 border-dashed border-l border-r">
			...
			<div className="flex flex-col gap-12 mt-8">
				<div className="flex flex-col gap-4" aria-label="Privacy First Description Section">
					<h2 className="text-lg font-semibold">1. 개인정보 수집항목</h2>
					<p>회사는 회원가입, 쇼핑몰 이용, 서비스 신청 및 제공 등을 위하여 다음과 같은 개인정보를 수집합니다.</p>
					<p>
						회사는 <strong>주민등록번호 및 아이핀(I-PIN) 정보는 수집하지 않습니다.</strong>
					</p>
				...
				<div aria-label="Privacy Second Description Section">
					<h4 className="text-lg font-semibold">2. 개인정보 수집 및 이용 목적</h4>
					...
					<p>
						회사는 서비스 제공에 필요한 <strong>최소한의 개인정보만을 수집</strong>하며, 수집한 개인정보를 목적 외의 용도로 이용하거나
						회원의 동의 없이 제3자에게 제공하지 않습니다.
					</p>
				</div>

				<div className="flex flex-col gap-4" aria-label="Privacy Third Description Section">
					<h3 className="text-lg font-semibold">3. 개인정보 보유 및 이용 기간</h3>
					<p>
						회사는 원칙적으로 개인정보의 수집 및 이용 목적이 달성된 후에는 해당 정보를 <strong>지체 없이 파기</strong>합니다.
					</p>
					<p>단, 관계법령에 따라 보존할 필요가 있는 경우에는 아래와 같이 일정 기간 보관합니다.</p>
					<h4 className="text-base font-semibold">(1) 관계법령에 따른 보관 기간</h4>
					<table border={1} className="w-full border-collapse">
						...
						<tbody>
							<tr>
								...
								<td className="text-left">전자상거래 등에서의 소비자보호에 관한 법률</td>
							...
							<tr>
								...
								<td className="text-left">신용정보의 이용 및 보호에 관한 법률</td>
								<td className="text-left">3년</td>
							</tr>
							<tr>
								<td className="text-left">본인확인 기록</td>
								<td className="text-left">정보통신망 이용촉진 및 정보보호 등에 관한 법률</td>
								<td className="text-left">6개월</td>
							</tr>
							<tr>
					...
					<ul>
						<li>회원의 개별 동의가 있는 경우에는 동의한 기간 동안 보관합니다.</li>
					</ul>
				</div>

				<div className="flex flex-col gap-4" aria-label="Privacy Fourth Description Section">
					<h3 className="text-lg font-semibold">4. 개인정보의 제3자 제공</h3>
					<p>
						회사는 회원의 개인정보를 수집·이용 목적 범위 내에서만 사용하며, 회원의 사전 동의 없이 개인정보를 제3자에게 제공하지 않습니다.
					</p>
					<h4 className="text-base font-semibold">(1) 예외 제공 사유</h4>
					<ol>
						<li>회원이 사전에 동의한 경우</li>
						<li>법령에 의거하거나 수사·조사 목적으로 관계기관의 요청이 있는 경우</li>
					</ol>
					<h3 className="text-base font-semibold">(2) 거래 이행을 위한 제공</h3>
					<p>
						서비스 이용 과정에서 주문 및 결제가 발생한 경우, 원활한 거래 이행 및 배송을 위하여 필요한 최소한의 정보가 제공될 수 있습니다.
					</p>
					<div>
						<p>
				...
				<p>그 밖에 개인정보의 제3자 제공이 필요한 경우에는 사전에 회원의 동의를 받은 후 제공됩니다.</p>
			</div>
		</section>
	);
}
