		...
		<section id="" className="mx-auto p-4 max-w-200 border-gray-200 border-dashed border-l border-r">
			...
			<div className="flex flex-col gap-12 mt-8">
				<div>
					...
					<p>
						본 약관은 쇼핑몰을 운영하는 회사(이하 “사이트”)가 제공하는 인터넷 관련 서비스 (이하 “서비스”)를 이용함에 있어 회원의 권리·의무
						및 책임사항을 규정함을 목적으로 합니다.
					</p>
					<p>서비스란 접속 가능한 유·무선 단말기의 종류와 상관없이 사이트가 제공하는 모든 서비스를 의미합니다.</p>
				</div>
				...
				<div>
					...
					<ol>
						...
						<li className="mt-4">
							<strong>회원</strong>이란 사이트에 개인정보를 제공하여 회원등록을 한 자로서, 사이트의 정보를 지속적으로 제공받으며 서비스를
							계속 이용할 수 있는 자를 말합니다.
						</li>
						<li className="mt-4">
							<strong>비밀번호</strong>란 회원의 동일성 확인과 권익 및 비밀보호를 위하여 회원이 설정하여 사이트에 등록한 영문과 숫자의
							조합을 말합니다.
						</li>
						<li>본 약관에서 정의되지 않은 용어는 관계법령 및 일반 상관례에 따릅니다.</li>
					</ol>
				</div>
				<div>
					<h3 className="page-subtitle">제3조 (약관의 명시와 개정)</h3>
					<ol>
						<li>회사는 약관의 내용, 상호, 대표자 성명, 주소, 전화번호, 전자우편주소, 사업자등록번호 등을 사이트 초기 화면에 게시합니다.</li>
						<li>회사는 관계법령을 위배하지 않는 범위에서 약관을 개정할 수 있습니다.</li>
						<li>약관을 개정할 경우 적용일자 및 개정사유를 명시하여 적용일자 7일 전부터 공지합니다.</li>
						<li>
							개정약관은 적용일자 이후 체결되는 계약에만 적용됩니다.
							<p>단, 기존 회원이 동의한 경우 개정약관을 적용할 수 있습니다.</p>
						</li>
						<li>개정약관 시행 이후 서비스를 계속 이용하는 경우 동의한 것으로 봅니다.</li>
					</ol>
				</div>

				<div>
					<h3 className="page-subtitle">제4조 (약관 외 준칙)</h3>
					<p>본 약관에 명시되지 않은 사항은 관계법령 및 일반 상관례에 따릅니다.</p>
				</div>

				<div>
					<h3 className="page-subtitle">제5조 (이용계약의 성립)</h3>
					<ol>
						<li>이용계약은 가입신청자가 약관에 동의하고 회원가입을 신청하여 회사가 이를 승인함으로써 성립합니다.</li>
						<li>
							...
							<ul className="ml-4 my-4">
								...
								<li className="list-decimal">동일한 전자우편주소로 중복 가입</li>
								<li className="list-decimal">부정한 목적의 이용</li>
								<li className="list-decimal">기타 약관 또는 법령 위반</li>
							</ul>
						</li>
						<li>회사는 설비 여유 또는 기술·업무상 문제로 승인을 유보할 수 있습니다.</li>
						<li>이용계약 성립 시점은 회사가 가입 완료를 표시한 시점으로 합니다.</li>
					</ol>
				</div>
				...
				<div>
					...
					<ol>
						...
						<li>회사의 공식 사이트 외 링크된 사이트에 대해서는 책임을 지지 않습니다.</li>
						<li>법령에 따라 필요한 경우 제3자에게 개인정보를 제공할 수 있습니다.</li>
					</ol>
				</div>
				...
				<div>
					...
					<ol>
						...
						<li>회사는 약관 위반 등의 사유가 있는 경우 계약을 해지할 수 있습니다.</li>
				...
				<div>
					...
					<p>회사는 회원이 약관을 위반하거나 거래질서를 해치는 경우 회원자격을 제한 또는 상실시킬 수 있습니다.</p>
				</div>
				...
				<div>
					...
					<p>회원은 관계법령 및 약관을 준수해야 하며, 다음 행위를 해서는 안 됩니다.</p>
					<ul className="ml-4 my-4">
				...
				<div>
					...
					<p>회사는 다음에 해당하는 게시물을 사전 통지 없이 삭제할 수 있습니다.</p>
					<ul className="ml-4 my-4">
				...
				<div>
					...
					<p>회사는 전자우편, SMS, PUSH 등으로 통지할 수 있으며, 공지로 갈음할 수 있습니다.</p>
				</div>
				...
				<div>
					...
					<p>개별 서비스에 별도 약관이 있을 경우 해당 약관이 우선 적용됩니다.</p>
				</div>
				...
				<div>
					...
					<p>천재지변, 시스템 장애 등 불가항력 사유로 서비스 제공을 중지할 수 있습니다.</p>
				</div>

				<div>
					<h3 className="page-subtitle">제19조 (정보 제공 및 광고)</h3>
					<p>회사는 서비스 운영과 관련된 정보를 제공하거나 광고를 게재할 수 있습니다.</p>
				</div>

				<div>
					<h3 className="page-subtitle">제20조 (구매신청)</h3>
					<p>회원은 상품 선택, 배송정보 입력, 결제 동의 절차를 거쳐 구매를 신청합니다.</p>
				</div>

				<div>
					<h3 className="page-subtitle">제21조 (대금지급방법)</h3>
					<p>신용카드, 계좌이체, 무통장입금 등 회사가 지정한 방법으로 결제할 수 있습니다.</p>
				</div>
				...
				<div>
					...
					<p>환불은 7영업일 이내 처리되며, 단순 변심 시 비용은 회원 부담입니다.</p>
				</div>
				...
				<div>
					...
					<p>권리 침해 게시물은 법령에 따라 게시중단 또는 삭제될 수 있습니다.</p>
				</div>
				<div>
					<h3 className="page-subtitle">제28조 (면책조항)</h3>
					<p>회사는 불가항력, 회원 귀책사유로 인한 손해에 대해 책임을 지지 않습니다.</p>
				</div>
				...
				<div>
					...
					<p>본 약관은 대한민국 법을 준거법으로 하며, 관할법원은 민사소송법에 따릅니다.</p>
