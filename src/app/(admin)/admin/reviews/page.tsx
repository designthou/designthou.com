...
import { AdminReviewList, Skeleton, Tabs, TabsContent, TabsList, TabsTrigger } from '@/components';
	...
	return (
		<section className="relative flex-1 p-4">
			...
			<Tabs defaultValue="online-course">
				<TabsList>
					{reviewsCategoryList.map(tabTrigger => (
				...
				<React.Suspense
					...
					{reviewsCategoryList.map((tab, idx) => (
						<TabsContent key={idx} value={tab} className="grid grid-cols-1 items-start gap-3 w-full">
