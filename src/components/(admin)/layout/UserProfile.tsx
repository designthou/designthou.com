      ...
      {userState?.user ? (
        <DropdownMenu>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span
                className={`${inSideNav ? "inline-block" : "hidden"} font-bold lg:inline`}
              >
                Kyle Kwon
              </span>
            </div>
        ...
        <MotionBlock className="ui-flex-center">
          <Link
            ...
            className="ui-flex-center gap-0 py-3 px-3 w-full font-semibold bg-gra border border-muted text-white text-center rounded-lg cursor-pointer transition-colors hover:bg-primary/90 lg:gap-2"
          >
            <User2 size={18} />
